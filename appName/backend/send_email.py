    ...
    r = resend.Emails.send(
        {
            ...
            "html": "<><h3>Good Morning!<h3><p>Here is the forecasted grid surplus times for the next couple days:</p><ul>"
            + timesHTML
            + "</ul><p>We suggest running display data appliances at these times.</p><p>Thanks for helping out so far, you've saved"
            + user["all_emis_saved"]
            + "pounds of carbon!</p><p>For more information, check out <a href=https://localhost:3000/impact-calculator>our website</a>.</p>&emsp; - &ensp;PowerCueTeam</>",
        }
    )
